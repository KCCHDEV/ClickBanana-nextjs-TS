...
function initializeDatabase(databaseName: string) {
  const databaseFolderPath = './MultiServiceDatabase';
  ...
  return function initializeTable(tableName: string) {
    const tableFilename = path.join(fullDatabaseFolderPath, `${tableName}.com`);
     ...
     */
    function saveTable(id: string, data: any) {
     ...
     */
    function removeFromTable(key: string) {
     ...
     */
    function addToTable(id: string | String | any, data: any) {
      saveTable(id, data);
    }
     ...
     */
    function getFromTable(key: string) {
     ...
     */
    function getWhere(condition: { good: any }) {
